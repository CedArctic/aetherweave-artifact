...
func newRateLimiter(p2pProvider p2p.P2P) *limiter {
	...
	// Aetherweave RPC requests
	topicMap[addEncoding(p2p.RPCAWHeartbeatV1)] = leakybucket.NewCollector(1, defaultBurstLimit, leakyBucketPeriod, false /* deleteEmptyBuckets */)
