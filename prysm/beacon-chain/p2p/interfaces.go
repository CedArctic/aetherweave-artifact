...
type PeerManager interface {
	...
	IsPeerAtLimit(inbound bool) bool
	GetMaxPeers() uint
}
...
// Functions added to P2P that Aetherweave needs to access from the sync package
type AWProvider interface {
	GetMultiAddrs() ([]multiaddr.Multiaddr, error)
