...
func (s *FakeP2P) LocalNetRec() *ethpb.NetworkRecord { return nil }

func (s *FakeP2P) StaticNetRecs() []*ethpb.NetworkRecord { return nil }

func (s *FakeP2P) GetPrivKey() *ecdsa.PrivateKey { return nil }

func (s *FakeP2P) IsPeerAtLimit(inbound bool) bool { return false }

func (s *FakeP2P) GetMaxPeers() uint { return 0 }

func (s *FakeP2P) GetMultiAddrs() ([]multiaddr.Multiaddr, error) { return nil, nil }

func (s *FakeP2P) GetContext() context.Context { return nil }
