...
// Aetherweave: LocalNetRec returns the NetworkRecord of the local peer.
func (*TestP2P) LocalNetRec() *ethpb.NetworkRecord {
	return new(ethpb.NetworkRecord)
}

// Aetherweave: StaticNetRecs returns the NetworkRecords of the statically passed peers.
func (*TestP2P) StaticNetRecs() []*ethpb.NetworkRecord {
	return make([]*ethpb.NetworkRecord, 0)
}
...
func (p *TestP2P) Send(ctx context.Context, msg interface{}, topic string, pid peer.ID) (network.Stream, error) {
	...
	suffix := core.ProtocolID(t + p.Encoding().ProtocolSuffix())
	stream, err := p.BHost.NewStream(ctx, pid, suffix)
	if err != nil {
		return nil, err
	}
...
func (s *TestP2P) GetPrivKey() *ecdsa.PrivateKey { return nil }

func (s *TestP2P) IsPeerAtLimit(inbound bool) bool { return false }

func (s *TestP2P) GetMaxPeers() uint { return 0 }

func (s *TestP2P) GetMultiAddrs() ([]multiaddr.Multiaddr, error) { return nil, nil }

func (s *TestP2P) GetContext() context.Context { return nil }
