...
// Specifies the protocol prefix for Aetherweave Req/Resp topics.
const AWProtocolPrefix = "/aetherweave"

// AWHeartbeatMessageName is the name for the Aetherweave v1 heatbeat message topic.
const AWHeartbeatMessageName = "/heartbeat"
...
const (
	...
	// AetherWeave topics
	RPCAWHeartbeatV1 = AWProtocolPrefix + AWHeartbeatMessageName + SchemaVersionV1
)
...
var RPCTopicMappings = map[string]interface{}{
	...
	// AetherWeave messages
	// Heartbeat Message
	RPCAWHeartbeatV1: new(pb.Request),
}
