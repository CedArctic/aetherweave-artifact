...
// Hash: a699cba79b06b5ba0afe9662bfd82307d5b72da243a9021c8d114ac48a7a4912
package eth
...
func (h *Hash) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	if size := len(h.Hash); size != 32 {
		err = ssz.ErrBytesLengthFn("--.Hash", size, 32)
		return
	}
...
func (h *Hash) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
...
// MarshalSSZ ssz marshals the PublicKey object
func (p *PublicKey) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(p)
}

// MarshalSSZTo ssz marshals the PublicKey object to a target array
func (p *PublicKey) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf

	// Field (0) 'Pubkey'
	if size := len(p.Pubkey); size != 36 {
		err = ssz.ErrBytesLengthFn("--.Pubkey", size, 36)
		return
	}
...
// UnmarshalSSZ ssz unmarshals the PublicKey object
func (p *PublicKey) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'Pubkey'
	if cap(p.Pubkey) == 0 {
		p.Pubkey = make([]byte, 0, len(buf[0:36]))
	}
	p.Pubkey = append(p.Pubkey, buf[0:36]...)

	return err
}

// SizeSSZ returns the ssz encoded size in bytes for the PublicKey object
func (p *PublicKey) SizeSSZ() (size int) {
	size = 36
	return
}

// HashTreeRoot ssz hashes the PublicKey object
func (p *PublicKey) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(p)
}

// HashTreeRootWith ssz hashes the PublicKey object with a hasher
func (p *PublicKey) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
...
// MarshalSSZ ssz marshals the Signature object
func (s *Signature) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(s)
}

// MarshalSSZTo ssz marshals the Signature object to a target array
func (s *Signature) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(4)
	...
	// Field (0) 'Signature'
	if size := len(s.Signature); size > 71 {
		err = ssz.ErrBytesLengthFn("--.Signature", size, 71)
		return
	}
...
// UnmarshalSSZ ssz unmarshals the Signature object
...
// SizeSSZ returns the ssz encoded size in bytes for the Signature object
...
// HashTreeRoot ssz hashes the Signature object
func (s *Signature) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(s)
}

// HashTreeRootWith ssz hashes the Signature object with a hasher
func (s *Signature) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	...
	// Field (0) 'Signature'
	{
		...
		hh.MerkleizeWithMixin(elemIndx, byteLen, (71+31)/32)
	}
...
// MarshalSSZ ssz marshals the AWMultiAddr object
func (a *AWMultiAddr) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(a)
}

// MarshalSSZTo ssz marshals the AWMultiAddr object to a target array
func (a *AWMultiAddr) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(4)

	// Offset (0) 'Multiaddr'
	dst = ssz.WriteOffset(dst, offset)
	offset += len(a.Multiaddr)

	// Field (0) 'Multiaddr'
	if size := len(a.Multiaddr); size > 128 {
		err = ssz.ErrBytesLengthFn("--.Multiaddr", size, 128)
		return
	}
	dst = append(dst, a.Multiaddr...)

	return
}

// UnmarshalSSZ ssz unmarshals the AWMultiAddr object
func (a *AWMultiAddr) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 4 {
		return ssz.ErrSize
	...
	// Field (0) 'Multiaddr'
	{
		...
		if cap(a.Multiaddr) == 0 {
			a.Multiaddr = make([]byte, 0, len(buf))
		}
		a.Multiaddr = append(a.Multiaddr, buf...)
	}
	return err
}

// SizeSSZ returns the ssz encoded size in bytes for the AWMultiAddr object
func (a *AWMultiAddr) SizeSSZ() (size int) {
	size = 4

	// Field (0) 'Multiaddr'
	size += len(a.Multiaddr)

	return
}

// HashTreeRoot ssz hashes the AWMultiAddr object
func (a *AWMultiAddr) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(a)
}

// HashTreeRootWith ssz hashes the AWMultiAddr object with a hasher
func (a *AWMultiAddr) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()

	// Field (0) 'Multiaddr'
	{
		elemIndx := hh.Index()
		byteLen := uint64(len(a.Multiaddr))
		if byteLen > 128 {
			err = ssz.ErrIncorrectListSize
			return
		}
		hh.PutBytes(a.Multiaddr)
...
// MarshalSSZ ssz marshals the CommitmentOpening object
func (c *CommitmentOpening) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(c)
}

// MarshalSSZTo ssz marshals the CommitmentOpening object to a target array
func (c *CommitmentOpening) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(40)
	...
	if dst, err = c.ParentHash.MarshalSSZTo(dst); err != nil {
		return
	}

	// Field (1) 'LeafIndex'
	dst = ssz.MarshalUint32(dst, c.LeafIndex)
	...
	// Field (2) 'Proof'
	if size := len(c.Proof); size > 768 {
		err = ssz.ErrListTooBigFn("--.Proof", size, 768)
		return
	}
	for ii := 0; ii < len(c.Proof); ii++ {
		if dst, err = c.Proof[ii].MarshalSSZTo(dst); err != nil {
			return
		}
	}
...
// UnmarshalSSZ ssz unmarshals the CommitmentOpening object
func (c *CommitmentOpening) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 40 {
		return ssz.ErrSize
	...
	if err = c.ParentHash.UnmarshalSSZ(buf[0:32]); err != nil {
		return err
	}

	// Field (1) 'LeafIndex'
	c.LeafIndex = ssz.UnmarshallUint32(buf[32:36])
	...
	{
		buf = tail[o2:]
		num, err := ssz.DivideInt2(len(buf), 32, 768)
		if err != nil {
			return err
		}
		c.Proof = make([]*Hash, num)
		for ii := 0; ii < num; ii++ {
			if c.Proof[ii] == nil {
				c.Proof[ii] = new(Hash)
			}
			if err = c.Proof[ii].UnmarshalSSZ(buf[ii*32 : (ii+1)*32]); err != nil {
				return err
			}
		}
	}
...
// SizeSSZ returns the ssz encoded size in bytes for the CommitmentOpening object
func (c *CommitmentOpening) SizeSSZ() (size int) {
	size = 40
...
// HashTreeRoot ssz hashes the CommitmentOpening object
func (c *CommitmentOpening) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(c)
}

// HashTreeRootWith ssz hashes the CommitmentOpening object with a hasher
func (c *CommitmentOpening) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()

	// Field (0) 'ParentHash'
	if err = c.ParentHash.HashTreeRootWith(hh); err != nil {
		return
	}

	// Field (1) 'LeafIndex'
	hh.PutUint32(c.LeafIndex)

	// Field (2) 'Proof'
	{
		subIndx := hh.Index()
		num := uint64(len(c.Proof))
		if num > 768 {
			err = ssz.ErrIncorrectListSize
			return
		}
		for _, elem := range c.Proof {
			if err = elem.HashTreeRootWith(hh); err != nil {
				return
			}
		}
		hh.MerkleizeWithMixin(subIndx, num, 768)
	}
...
// MarshalSSZ ssz marshals the NetworkRecord object
func (n *NetworkRecord) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(n)
}

// MarshalSSZTo ssz marshals the NetworkRecord object to a target array
func (n *NetworkRecord) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(88)
	...
	if dst, err = n.PublicKey.MarshalSSZTo(dst); err != nil {
		return
	}

	// Offset (1) 'ProofOfStake'
	dst = ssz.WriteOffset(dst, offset)
	if n.ProofOfStake == nil {
		n.ProofOfStake = new(ZKP)
	}
	offset += n.ProofOfStake.SizeSSZ()

	// Field (2) 'MerkleRoot'
	if n.MerkleRoot == nil {
		n.MerkleRoot = new(Hash)
	}
	if dst, err = n.MerkleRoot.MarshalSSZTo(dst); err != nil {
		return
	}
	...
	dst = ssz.WriteOffset(dst, offset)
	if n.Multiaddr == nil {
		n.Multiaddr = new(AWMultiAddr)
	}
	offset += n.Multiaddr.SizeSSZ()

	// Field (4) 'Timestamp'
	dst = ssz.MarshalUint64(dst, n.Timestamp)

	// Offset (5) 'Signature'
	dst = ssz.WriteOffset(dst, offset)
	if n.Signature == nil {
		n.Signature = new(Signature)
	}
	offset += n.Signature.SizeSSZ()

	// Field (1) 'ProofOfStake'
	if dst, err = n.ProofOfStake.MarshalSSZTo(dst); err != nil {
		return
	}

	// Field (3) 'Multiaddr'
	if dst, err = n.Multiaddr.MarshalSSZTo(dst); err != nil {
		return
	}

	// Field (5) 'Signature'
	if dst, err = n.Signature.MarshalSSZTo(dst); err != nil {
		return
	}
...
// UnmarshalSSZ ssz unmarshals the NetworkRecord object
func (n *NetworkRecord) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 88 {
		return ssz.ErrSize
	...
	if err = n.PublicKey.UnmarshalSSZ(buf[0:36]); err != nil {
		return err
	}

	// Offset (1) 'ProofOfStake'
	if o1 = ssz.ReadOffset(buf[36:40]); o1 > size {
		return ssz.ErrOffset
	}
	...
	if err = n.MerkleRoot.UnmarshalSSZ(buf[40:72]); err != nil {
		return err
	}

	// Offset (3) 'Multiaddr'
	if o3 = ssz.ReadOffset(buf[72:76]); o3 > size || o1 > o3 {
		return ssz.ErrOffset
	}

	// Field (4) 'Timestamp'
	n.Timestamp = ssz.UnmarshallUint64(buf[76:84])

	// Offset (5) 'Signature'
	if o5 = ssz.ReadOffset(buf[84:88]); o5 > size || o3 > o5 {
		return ssz.ErrOffset
	}
	...
	// Field (1) 'ProofOfStake'
	{
		...
		if err = n.ProofOfStake.UnmarshalSSZ(buf); err != nil {
			return err
		}
	}
	...
	// Field (3) 'Multiaddr'
	{
		...
		if err = n.Multiaddr.UnmarshalSSZ(buf); err != nil {
			return err
		}
	}
	...
	// Field (5) 'Signature'
	{
		...
		if err = n.Signature.UnmarshalSSZ(buf); err != nil {
			return err
		}
	}
	return err
...
// SizeSSZ returns the ssz encoded size in bytes for the NetworkRecord object
func (n *NetworkRecord) SizeSSZ() (size int) {
	size = 88
	...
	size += n.ProofOfStake.SizeSSZ()

	// Field (3) 'Multiaddr'
	if n.Multiaddr == nil {
		n.Multiaddr = new(AWMultiAddr)
	}
	size += n.Multiaddr.SizeSSZ()

	// Field (5) 'Signature'
	if n.Signature == nil {
		n.Signature = new(Signature)
	}
	size += n.Signature.SizeSSZ()

	return
}

// HashTreeRoot ssz hashes the NetworkRecord object
func (n *NetworkRecord) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(n)
}

// HashTreeRootWith ssz hashes the NetworkRecord object with a hasher
func (n *NetworkRecord) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()

	// Field (0) 'PublicKey'
	if err = n.PublicKey.HashTreeRootWith(hh); err != nil {
		return
	}

	// Field (1) 'ProofOfStake'
	if err = n.ProofOfStake.HashTreeRootWith(hh); err != nil {
		return
	}

	// Field (2) 'MerkleRoot'
	if err = n.MerkleRoot.HashTreeRootWith(hh); err != nil {
		return
	}

	// Field (3) 'Multiaddr'
	if err = n.Multiaddr.HashTreeRootWith(hh); err != nil {
		return
	}

	// Field (4) 'Timestamp'
	hh.PutUint64(n.Timestamp)

	// Field (5) 'Signature'
	if err = n.Signature.HashTreeRootWith(hh); err != nil {
		return
	}
...
// MarshalSSZ ssz marshals the CommitmentRecord object
func (c *CommitmentRecord) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(c)
}

// MarshalSSZTo ssz marshals the CommitmentRecord object to a target array
func (c *CommitmentRecord) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(76)
	...
	if dst, err = c.RootHash.MarshalSSZTo(dst); err != nil {
		return
	}

	// Field (1) 'RoundNumber'
	dst = ssz.MarshalUint64(dst, c.RoundNumber)

	// Field (2) 'SlashShare'
	if size := len(c.SlashShare); size != 32 {
		err = ssz.ErrBytesLengthFn("--.SlashShare", size, 32)
		return
	}
	dst = append(dst, c.SlashShare...)

	// Offset (3) 'ShareProof'
	dst = ssz.WriteOffset(dst, offset)
	if c.ShareProof == nil {
		c.ShareProof = new(ZKP)
	}
	offset += c.ShareProof.SizeSSZ()

	// Field (3) 'ShareProof'
	if dst, err = c.ShareProof.MarshalSSZTo(dst); err != nil {
		return
	}
...
// UnmarshalSSZ ssz unmarshals the CommitmentRecord object
func (c *CommitmentRecord) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 76 {
		return ssz.ErrSize
	...
	if err = c.RootHash.UnmarshalSSZ(buf[0:32]); err != nil {
		return err
	}

	// Field (1) 'RoundNumber'
	c.RoundNumber = ssz.UnmarshallUint64(buf[32:40])

	// Field (2) 'SlashShare'
	if cap(c.SlashShare) == 0 {
		c.SlashShare = make([]byte, 0, len(buf[40:72]))
	}
	c.SlashShare = append(c.SlashShare, buf[40:72]...)
	...
	// Field (3) 'ShareProof'
	{
		...
		if err = c.ShareProof.UnmarshalSSZ(buf); err != nil {
			return err
		}
	}
	return err
...
// SizeSSZ returns the ssz encoded size in bytes for the CommitmentRecord object
func (c *CommitmentRecord) SizeSSZ() (size int) {
	size = 76
	...
	size += c.ShareProof.SizeSSZ()

	return
}

// HashTreeRoot ssz hashes the CommitmentRecord object
func (c *CommitmentRecord) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(c)
}

// HashTreeRootWith ssz hashes the CommitmentRecord object with a hasher
func (c *CommitmentRecord) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()

	// Field (0) 'RootHash'
	if err = c.RootHash.HashTreeRootWith(hh); err != nil {
		return
	}

	// Field (1) 'RoundNumber'
	hh.PutUint64(c.RoundNumber)
	...
	hh.PutBytes(c.SlashShare)

	// Field (3) 'ShareProof'
	if err = c.ShareProof.HashTreeRootWith(hh); err != nil {
		return
	}
...
// MarshalSSZ ssz marshals the PeerRecord object
func (p *PeerRecord) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(p)
}

// MarshalSSZTo ssz marshals the PeerRecord object to a target array
func (p *PeerRecord) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(8)
	...
	dst = ssz.WriteOffset(dst, offset)
	if p.NetRecord == nil {
		p.NetRecord = new(NetworkRecord)
	}
	offset += p.NetRecord.SizeSSZ()

	// Offset (1) 'Commitments'
	dst = ssz.WriteOffset(dst, offset)
	for ii := 0; ii < len(p.Commitments); ii++ {
		offset += 4
		offset += p.Commitments[ii].SizeSSZ()
	}

	// Field (0) 'NetRecord'
	if dst, err = p.NetRecord.MarshalSSZTo(dst); err != nil {
		return
	}

	// Field (1) 'Commitments'
	if size := len(p.Commitments); size > 4560 {
		err = ssz.ErrListTooBigFn("--.Commitments", size, 4560)
		return
	}
	{
		offset = 4 * len(p.Commitments)
		for ii := 0; ii < len(p.Commitments); ii++ {
			dst = ssz.WriteOffset(dst, offset)
			offset += p.Commitments[ii].SizeSSZ()
		}
	...
	for ii := 0; ii < len(p.Commitments); ii++ {
		if dst, err = p.Commitments[ii].MarshalSSZTo(dst); err != nil {
			return
		}
	}
...
// UnmarshalSSZ ssz unmarshals the PeerRecord object
func (p *PeerRecord) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 8 {
		return ssz.ErrSize
	...
	// Field (0) 'NetRecord'
	{
		...
		if err = p.NetRecord.UnmarshalSSZ(buf); err != nil {
			return err
		}
	}
	...
	{
		buf = tail[o1:]
		num, err := ssz.DecodeDynamicLength(buf, 4560)
		if err != nil {
			return err
		}
		p.Commitments = make([]*CommitmentRecord, num)
		err = ssz.UnmarshalDynamic(buf, num, func(indx int, buf []byte) (err error) {
			if p.Commitments[indx] == nil {
				p.Commitments[indx] = new(CommitmentRecord)
			}
			if err = p.Commitments[indx].UnmarshalSSZ(buf); err != nil {
				return err
			}
			return nil
		})
...
// SizeSSZ returns the ssz encoded size in bytes for the PeerRecord object
func (p *PeerRecord) SizeSSZ() (size int) {
	size = 8
	...
	size += p.NetRecord.SizeSSZ()

	// Field (1) 'Commitments'
	for ii := 0; ii < len(p.Commitments); ii++ {
		size += 4
		size += p.Commitments[ii].SizeSSZ()
	}

	return
}

// HashTreeRoot ssz hashes the PeerRecord object
func (p *PeerRecord) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(p)
}

// HashTreeRootWith ssz hashes the PeerRecord object with a hasher
func (p *PeerRecord) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()

	// Field (0) 'NetRecord'
	if err = p.NetRecord.HashTreeRootWith(hh); err != nil {
		return
	}
	...
	{
		subIndx := hh.Index()
		num := uint64(len(p.Commitments))
		if num > 4560 {
			err = ssz.ErrIncorrectListSize
			return
		}
		for _, elem := range p.Commitments {
			if err = elem.HashTreeRootWith(hh); err != nil {
				return
			}
		}
		hh.MerkleizeWithMixin(subIndx, num, 4560)
	}
...
// MarshalSSZ ssz marshals the SlashProof object
func (s *SlashProof) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(s)
}

// MarshalSSZTo ssz marshals the SlashProof object to a target array
func (s *SlashProof) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(44)

	// Field (0) 'Slashee'
	if s.Slashee == nil {
		s.Slashee = new(PublicKey)
	}
	if dst, err = s.Slashee.MarshalSSZTo(dst); err != nil {
		return
	}
	...
	dst = ssz.WriteOffset(dst, offset)
	if s.Record_1 == nil {
		s.Record_1 = new(CommitmentRecord)
	}
	offset += s.Record_1.SizeSSZ()

	// Offset (2) 'Record_2'
	dst = ssz.WriteOffset(dst, offset)
	if s.Record_2 == nil {
		s.Record_2 = new(CommitmentRecord)
	}
	offset += s.Record_2.SizeSSZ()

	// Field (1) 'Record_1'
	if dst, err = s.Record_1.MarshalSSZTo(dst); err != nil {
		return
	}

	// Field (2) 'Record_2'
	if dst, err = s.Record_2.MarshalSSZTo(dst); err != nil {
		return
	}
...
// UnmarshalSSZ ssz unmarshals the SlashProof object
func (s *SlashProof) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 44 {
		return ssz.ErrSize
	...
	if err = s.Slashee.UnmarshalSSZ(buf[0:36]); err != nil {
		return err
	}
	...
	// Offset (2) 'Record_2'
	if o2 = ssz.ReadOffset(buf[40:44]); o2 > size || o1 > o2 {
		return ssz.ErrOffset
	}
	...
	// Field (1) 'Record_1'
	{
		...
		if err = s.Record_1.UnmarshalSSZ(buf); err != nil {
			return err
		}
	}
	...
	// Field (2) 'Record_2'
	{
		...
		if err = s.Record_2.UnmarshalSSZ(buf); err != nil {
			return err
		}
	}
	return err
...
// SizeSSZ returns the ssz encoded size in bytes for the SlashProof object
func (s *SlashProof) SizeSSZ() (size int) {
	size = 44
	...
	size += s.Record_1.SizeSSZ()

	// Field (2) 'Record_2'
	if s.Record_2 == nil {
		s.Record_2 = new(CommitmentRecord)
	}
	size += s.Record_2.SizeSSZ()

	return
}

// HashTreeRoot ssz hashes the SlashProof object
func (s *SlashProof) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(s)
}

// HashTreeRootWith ssz hashes the SlashProof object with a hasher
func (s *SlashProof) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()

	// Field (0) 'Slashee'
	if err = s.Slashee.HashTreeRootWith(hh); err != nil {
		return
	}

	// Field (1) 'Record_1'
	if err = s.Record_1.HashTreeRootWith(hh); err != nil {
		return
	}

	// Field (2) 'Record_2'
	if err = s.Record_2.HashTreeRootWith(hh); err != nil {
		return
	}
...
func (r *Request) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Offset (0) 'Nonces'
	dst = ssz.WriteOffset(dst, offset)
	offset += len(r.Nonces) * 8

	// Offset (1) 'SenderRecord'
	dst = ssz.WriteOffset(dst, offset)
	if r.SenderRecord == nil {
		r.SenderRecord = new(NetworkRecord)
	}
	offset += r.SenderRecord.SizeSSZ()

	// Offset (2) 'CommitmentRecord'
	dst = ssz.WriteOffset(dst, offset)
	if r.CommitmentRecord == nil {
		r.CommitmentRecord = new(CommitmentRecord)
	}
	offset += r.CommitmentRecord.SizeSSZ()

	// Offset (3) 'CommitmentOpening'
	dst = ssz.WriteOffset(dst, offset)
	if r.CommitmentOpening == nil {
		r.CommitmentOpening = new(CommitmentOpening)
	}
	offset += r.CommitmentOpening.SizeSSZ()
	...
	offset += r.Signature.SizeSSZ()

	// Field (0) 'Nonces'
	if size := len(r.Nonces); size > 5220000 {
		err = ssz.ErrListTooBigFn("--.Nonces", size, 5220000)
		return
	}
	for ii := 0; ii < len(r.Nonces); ii++ {
		dst = ssz.MarshalUint64(dst, r.Nonces[ii])
	}

	// Field (1) 'SenderRecord'
	if dst, err = r.SenderRecord.MarshalSSZTo(dst); err != nil {
		return
	}

	// Field (2) 'CommitmentRecord'
	if dst, err = r.CommitmentRecord.MarshalSSZTo(dst); err != nil {
		return
	}

	// Field (3) 'CommitmentOpening'
	if dst, err = r.CommitmentOpening.MarshalSSZTo(dst); err != nil {
		return
	}

	// Field (4) 'Signature'
	if dst, err = r.Signature.MarshalSSZTo(dst); err != nil {
		return
	}
...
func (r *Request) UnmarshalSSZ(buf []byte) error {
	...
	{
		buf = tail[o0:o1]
		num, err := ssz.DivideInt2(len(buf), 8, 5220000)
		if err != nil {
			return err
		}
		r.Nonces = ssz.ExtendUint64(r.Nonces, num)
		for ii := 0; ii < num; ii++ {
			r.Nonces[ii] = ssz.UnmarshallUint64(buf[ii*8 : (ii+1)*8])
		}
	}
	...
	// Field (1) 'SenderRecord'
	{
		...
		if err = r.SenderRecord.UnmarshalSSZ(buf); err != nil {
			return err
		}
	}
	...
	// Field (2) 'CommitmentRecord'
	{
		...
		if err = r.CommitmentRecord.UnmarshalSSZ(buf); err != nil {
			return err
		}
	}
	...
	// Field (3) 'CommitmentOpening'
	{
		...
		if err = r.CommitmentOpening.UnmarshalSSZ(buf); err != nil {
			return err
		}
	}
	...
	// Field (4) 'Signature'
	{
		...
		if err = r.Signature.UnmarshalSSZ(buf); err != nil {
			return err
		}
	}
	return err
...
func (r *Request) SizeSSZ() (size int) {
	...
	size += r.SenderRecord.SizeSSZ()

	// Field (2) 'CommitmentRecord'
	if r.CommitmentRecord == nil {
		r.CommitmentRecord = new(CommitmentRecord)
	}
	size += r.CommitmentRecord.SizeSSZ()

	// Field (3) 'CommitmentOpening'
	if r.CommitmentOpening == nil {
		r.CommitmentOpening = new(CommitmentOpening)
	}
	size += r.CommitmentOpening.SizeSSZ()

	// Field (4) 'Signature'
	if r.Signature == nil {
		r.Signature = new(Signature)
	}
	size += r.Signature.SizeSSZ()

	return
}

// HashTreeRoot ssz hashes the Request object
func (r *Request) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(r)
}

// HashTreeRootWith ssz hashes the Request object with a hasher
func (r *Request) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
	...
	// Field (0) 'Nonces'
	{
		...
		subIndx := hh.Index()
		for _, i := range r.Nonces {
			hh.AppendUint64(i)
		}
		hh.FillUpTo32()

		numItems := uint64(len(r.Nonces))
		hh.MerkleizeWithMixin(subIndx, numItems, ssz.CalculateLimit(5220000, numItems, 8))
	}

	// Field (1) 'SenderRecord'
	if err = r.SenderRecord.HashTreeRootWith(hh); err != nil {
		return
	}

	// Field (2) 'CommitmentRecord'
	if err = r.CommitmentRecord.HashTreeRootWith(hh); err != nil {
		return
	}

	// Field (3) 'CommitmentOpening'
	if err = r.CommitmentOpening.HashTreeRootWith(hh); err != nil {
		return
	}

	// Field (4) 'Signature'
	if err = r.Signature.HashTreeRootWith(hh); err != nil {
		return
	}
...
func (r *Response) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Offset (0) 'Records'
	dst = ssz.WriteOffset(dst, offset)
	for ii := 0; ii < len(r.Records); ii++ {
		offset += 4
		offset += r.Records[ii].SizeSSZ()
	}

	// Offset (1) 'SlashProofs'
	dst = ssz.WriteOffset(dst, offset)
	for ii := 0; ii < len(r.SlashProofs); ii++ {
		offset += 4
		offset += r.SlashProofs[ii].SizeSSZ()
	}

	// Offset (2) 'RecordsB'
	dst = ssz.WriteOffset(dst, offset)
	for ii := 0; ii < len(r.RecordsB); ii++ {
		offset += 4
		offset += r.RecordsB[ii].SizeSSZ()
	}

	// Field (0) 'Records'
	if size := len(r.Records); size > 5220000 {
		err = ssz.ErrListTooBigFn("--.Records", size, 5220000)
		return
	}
	{
		offset = 4 * len(r.Records)
		for ii := 0; ii < len(r.Records); ii++ {
			dst = ssz.WriteOffset(dst, offset)
			offset += r.Records[ii].SizeSSZ()
		}
	...
	for ii := 0; ii < len(r.Records); ii++ {
		if dst, err = r.Records[ii].MarshalSSZTo(dst); err != nil {
			return
		}
	}

	// Field (1) 'SlashProofs'
	if size := len(r.SlashProofs); size > 25900 {
		err = ssz.ErrListTooBigFn("--.SlashProofs", size, 25900)
		return
	}
	{
		offset = 4 * len(r.SlashProofs)
		for ii := 0; ii < len(r.SlashProofs); ii++ {
			dst = ssz.WriteOffset(dst, offset)
			offset += r.SlashProofs[ii].SizeSSZ()
		}
	...
	for ii := 0; ii < len(r.SlashProofs); ii++ {
		if dst, err = r.SlashProofs[ii].MarshalSSZTo(dst); err != nil {
			return
		}
	}

	// Field (2) 'RecordsB'
	if size := len(r.RecordsB); size > 5220000 {
		err = ssz.ErrListTooBigFn("--.RecordsB", size, 5220000)
		return
	}
	{
		offset = 4 * len(r.RecordsB)
		for ii := 0; ii < len(r.RecordsB); ii++ {
			dst = ssz.WriteOffset(dst, offset)
			offset += r.RecordsB[ii].SizeSSZ()
		}
	...
	for ii := 0; ii < len(r.RecordsB); ii++ {
		if dst, err = r.RecordsB[ii].MarshalSSZTo(dst); err != nil {
			return
		}
	}
...
func (r *Response) UnmarshalSSZ(buf []byte) error {
	...
	{
		buf = tail[o0:o1]
		num, err := ssz.DecodeDynamicLength(buf, 5220000)
		if err != nil {
			return err
		}
		r.Records = make([]*PeerRecord, num)
		err = ssz.UnmarshalDynamic(buf, num, func(indx int, buf []byte) (err error) {
			if r.Records[indx] == nil {
				r.Records[indx] = new(PeerRecord)
			}
			if err = r.Records[indx].UnmarshalSSZ(buf); err != nil {
				return err
			}
			return nil
		})
	...
	{
		buf = tail[o1:o2]
		num, err := ssz.DecodeDynamicLength(buf, 25900)
		if err != nil {
			return err
		}
		r.SlashProofs = make([]*SlashProof, num)
		err = ssz.UnmarshalDynamic(buf, num, func(indx int, buf []byte) (err error) {
			if r.SlashProofs[indx] == nil {
				r.SlashProofs[indx] = new(SlashProof)
			}
			if err = r.SlashProofs[indx].UnmarshalSSZ(buf); err != nil {
				return err
			}
			return nil
		})
	...
	// Field (2) 'RecordsB'
	{
		...
		r.RecordsB = make([]*PeerRecord, num)
		err = ssz.UnmarshalDynamic(buf, num, func(indx int, buf []byte) (err error) {
			if r.RecordsB[indx] == nil {
				r.RecordsB[indx] = new(PeerRecord)
			}
			if err = r.RecordsB[indx].UnmarshalSSZ(buf); err != nil {
				return err
			}
			return nil
		})
...
func (r *Response) SizeSSZ() (size int) {
	...
	for ii := 0; ii < len(r.Records); ii++ {
		size += 4
		size += r.Records[ii].SizeSSZ()
	}

	// Field (1) 'SlashProofs'
	for ii := 0; ii < len(r.SlashProofs); ii++ {
		size += 4
		size += r.SlashProofs[ii].SizeSSZ()
	}

	// Field (2) 'RecordsB'
	for ii := 0; ii < len(r.RecordsB); ii++ {
		size += 4
		size += r.RecordsB[ii].SizeSSZ()
	}

	return
}

// HashTreeRoot ssz hashes the Response object
func (r *Response) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(r)
}

// HashTreeRootWith ssz hashes the Response object with a hasher
func (r *Response) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
	...
	// Field (0) 'Records'
	{
		...
		for _, elem := range r.Records {
			if err = elem.HashTreeRootWith(hh); err != nil {
				return
			}
		}
		hh.MerkleizeWithMixin(subIndx, num, 5220000)
	}

	// Field (1) 'SlashProofs'
	{
		subIndx := hh.Index()
		num := uint64(len(r.SlashProofs))
		if num > 25900 {
			err = ssz.ErrIncorrectListSize
			return
		}
		for _, elem := range r.SlashProofs {
			if err = elem.HashTreeRootWith(hh); err != nil {
				return
			}
		}
		hh.MerkleizeWithMixin(subIndx, num, 25900)
	}

	// Field (2) 'RecordsB'
	{
		subIndx := hh.Index()
		num := uint64(len(r.RecordsB))
		if num > 5220000 {
			err = ssz.ErrIncorrectListSize
			return
		}
		for _, elem := range r.RecordsB {
			if err = elem.HashTreeRootWith(hh); err != nil {
				return
			}
		}
...
// MarshalSSZ ssz marshals the PI_A object
func (p *PI_A) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(p)
}

// MarshalSSZTo ssz marshals the PI_A object to a target array
func (p *PI_A) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(12)
	...
	// Field (0) 'A'
	if size := len(p.A); size > 32 {
		err = ssz.ErrBytesLengthFn("--.A", size, 32)
		return
	}
	dst = append(dst, p.A...)

	// Field (1) 'B'
	if size := len(p.B); size > 32 {
		err = ssz.ErrBytesLengthFn("--.B", size, 32)
		return
	}
	dst = append(dst, p.B...)

	// Field (2) 'C'
	if size := len(p.C); size > 32 {
		err = ssz.ErrBytesLengthFn("--.C", size, 32)
		return
	}
	dst = append(dst, p.C...)
...
// UnmarshalSSZ ssz unmarshals the PI_A object
func (p *PI_A) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 12 {
		return ssz.ErrSize
...
// SizeSSZ returns the ssz encoded size in bytes for the PI_A object
func (p *PI_A) SizeSSZ() (size int) {
	size = 12
...
// HashTreeRoot ssz hashes the PI_A object
func (p *PI_A) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(p)
}

// HashTreeRootWith ssz hashes the PI_A object with a hasher
func (p *PI_A) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()

	// Field (0) 'A'
	{
		elemIndx := hh.Index()
		byteLen := uint64(len(p.A))
		if byteLen > 32 {
			err = ssz.ErrIncorrectListSize
			return
		}
...
// MarshalSSZ ssz marshals the PI_B_Point object
func (p *PI_B_Point) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(p)
}

// MarshalSSZTo ssz marshals the PI_B_Point object to a target array
func (p *PI_B_Point) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(8)
...
// UnmarshalSSZ ssz unmarshals the PI_B_Point object
func (p *PI_B_Point) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 8 {
		return ssz.ErrSize
...
// SizeSSZ returns the ssz encoded size in bytes for the PI_B_Point object
func (p *PI_B_Point) SizeSSZ() (size int) {
	size = 8
...
// HashTreeRoot ssz hashes the PI_B_Point object
func (p *PI_B_Point) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(p)
}

// HashTreeRootWith ssz hashes the PI_B_Point object with a hasher
func (p *PI_B_Point) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
...
// MarshalSSZ ssz marshals the PI_B object
func (p *PI_B) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(p)
}

// MarshalSSZTo ssz marshals the PI_B object to a target array
func (p *PI_B) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(4)

	// Offset (0) 'Points'
	dst = ssz.WriteOffset(dst, offset)
	for ii := 0; ii < len(p.Points); ii++ {
		offset += 4
		offset += p.Points[ii].SizeSSZ()
	}

	// Field (0) 'Points'
	if size := len(p.Points); size > 192 {
		err = ssz.ErrListTooBigFn("--.Points", size, 192)
		return
	}
	{
		offset = 4 * len(p.Points)
		for ii := 0; ii < len(p.Points); ii++ {
			dst = ssz.WriteOffset(dst, offset)
			offset += p.Points[ii].SizeSSZ()
		}
	...
	for ii := 0; ii < len(p.Points); ii++ {
		if dst, err = p.Points[ii].MarshalSSZTo(dst); err != nil {
			return
		}
	}
...
// UnmarshalSSZ ssz unmarshals the PI_B object
func (p *PI_B) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 4 {
		return ssz.ErrSize
	...
	{
		buf = tail[o0:]
		num, err := ssz.DecodeDynamicLength(buf, 192)
		if err != nil {
			return err
		}
		p.Points = make([]*PI_B_Point, num)
		err = ssz.UnmarshalDynamic(buf, num, func(indx int, buf []byte) (err error) {
			if p.Points[indx] == nil {
				p.Points[indx] = new(PI_B_Point)
			}
			if err = p.Points[indx].UnmarshalSSZ(buf); err != nil {
				return err
			}
			return nil
		})
...
// SizeSSZ returns the ssz encoded size in bytes for the PI_B object
func (p *PI_B) SizeSSZ() (size int) {
	size = 4

	// Field (0) 'Points'
	for ii := 0; ii < len(p.Points); ii++ {
		size += 4
		size += p.Points[ii].SizeSSZ()
	}

	return
}

// HashTreeRoot ssz hashes the PI_B object
func (p *PI_B) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(p)
}

// HashTreeRootWith ssz hashes the PI_B object with a hasher
func (p *PI_B) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()

	// Field (0) 'Points'
	{
		subIndx := hh.Index()
		num := uint64(len(p.Points))
		if num > 192 {
			err = ssz.ErrIncorrectListSize
			return
		}
		for _, elem := range p.Points {
			if err = elem.HashTreeRootWith(hh); err != nil {
				return
			}
		}
		hh.MerkleizeWithMixin(subIndx, num, 192)
	}
...
// MarshalSSZ ssz marshals the PI_C object
func (p *PI_C) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(p)
}

// MarshalSSZTo ssz marshals the PI_C object to a target array
func (p *PI_C) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(12)
...
// UnmarshalSSZ ssz unmarshals the PI_C object
func (p *PI_C) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 12 {
		return ssz.ErrSize
...
// SizeSSZ returns the ssz encoded size in bytes for the PI_C object
func (p *PI_C) SizeSSZ() (size int) {
	size = 12
...
// HashTreeRoot ssz hashes the PI_C object
func (p *PI_C) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(p)
}

// HashTreeRootWith ssz hashes the PI_C object with a hasher
func (p *PI_C) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
...
// MarshalSSZ ssz marshals the ZKP object
func (z *ZKP) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(z)
}

// MarshalSSZTo ssz marshals the ZKP object to a target array
func (z *ZKP) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(12)
	...
	offset += z.PiC.SizeSSZ()

	// Field (0) 'PiA'
	if dst, err = z.PiA.MarshalSSZTo(dst); err != nil {
		return
	}

	// Field (1) 'PiB'
	if dst, err = z.PiB.MarshalSSZTo(dst); err != nil {
		return
	}

	// Field (2) 'PiC'
	if dst, err = z.PiC.MarshalSSZTo(dst); err != nil {
		return
	}
...
// UnmarshalSSZ ssz unmarshals the ZKP object
func (z *ZKP) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 12 {
		return ssz.ErrSize
	...
	// Field (0) 'PiA'
	{
		...
		if err = z.PiA.UnmarshalSSZ(buf); err != nil {
			return err
		}
	}
	...
	// Field (1) 'PiB'
	{
		...
		if err = z.PiB.UnmarshalSSZ(buf); err != nil {
			return err
		}
	}
	...
	// Field (2) 'PiC'
	{
		...
		if err = z.PiC.UnmarshalSSZ(buf); err != nil {
			return err
		}
	}
	return err
...
// SizeSSZ returns the ssz encoded size in bytes for the ZKP object
func (z *ZKP) SizeSSZ() (size int) {
	size = 12
...
// HashTreeRoot ssz hashes the ZKP object
func (z *ZKP) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(z)
}

// HashTreeRootWith ssz hashes the ZKP object with a hasher
func (z *ZKP) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()

	// Field (0) 'PiA'
	if err = z.PiA.HashTreeRootWith(hh); err != nil {
		return
	}

	// Field (1) 'PiB'
	if err = z.PiB.HashTreeRootWith(hh); err != nil {
		return
	}

	// Field (2) 'PiC'
	if err = z.PiC.HashTreeRootWith(hh); err != nil {
		return
	}
