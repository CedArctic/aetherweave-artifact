...
func Groth16ProverRaw(zkey []byte,
	...
	for {
		...
		r := C.groth16_prover(
                        zkeyPointer, C.ulonglong(len(zkey)),
                        wtnsPointer, C.ulonglong(len(witness)),
                        proofBufferPointer, (*C.ulonglong)(proofBufSizePointer),
                        publicBufferPointer, (*C.ulonglong)(publicBufSizePointer),
                        errorMessagePointer, errorBufSize)
