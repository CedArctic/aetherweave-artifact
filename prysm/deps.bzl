...
def prysm_deps():
    ...
    go_repository(
        ...
        sum = "h1:NdkceRLJo/pI4UpcjVah4lN/a3yzxRUGXqxbWcYh9mY=",
        version = "v0.0.17",
    )
    go_repository(
        name = "com_github_iden3_go_iden3_crypto_v2",
        importpath = "github.com/iden3/go-iden3-crypto/v2",
        sum = "h1:MpP+NlT1l5g9T9Y1m486eWnM1cojqa9K0qxd+kv3E/M=",
        version = "v2.0.0",
    )
    go_repository(
        name = "com_github_iden3_go_rapidsnark_types",
        importpath = "github.com/iden3/go-rapidsnark/types",
        sum = "h1:f0s1Qdut1qHe1O67+m+xUVRBPwSXnq5j0xSrBi0jqM4=",
        version = "v0.0.3",
    )
    go_repository(
        name = "com_github_iden3_go_rapidsnark_verifier",
        importpath = "github.com/iden3/go-rapidsnark/verifier",
        sum = "h1:J7y0ovrEjDQoWtZmlrp4tgGng1A9faMeYsQH4igAEqA=",
        version = "v0.0.5",
    )
    go_repository(
        name = "com_github_iden3_go_rapidsnark_witness_v2",
        importpath = "github.com/iden3/go-rapidsnark/witness/v2",
        sum = "h1:mkY6VDfwKVJc83QGKmwVXY2LYepidPrFAxskrjr8UCs=",
        version = "v2.0.0",
    )
    go_repository(
        name = "com_github_iden3_go_rapidsnark_witness_wasmer",
        importpath = "github.com/iden3/go-rapidsnark/witness/wasmer",
        sum = "h1:lVQMc5Y9Ab1ycVUXAleIrSr30/Z3PqetRKJ/4DDHK3M=",
        version = "v0.0.0-20250114164021-779c4f7dbadd",
    )
    go_repository(
    ...
    go_repository(
        ...
        replace = "github.com/CedArctic/go-libp2p-bjj",
        sum = "h1:QoRRQetTobMGUwMcAdGZy1V9WOztVbOIoLnHXjuSZ34=",
        version = "v0.36.8",
    )
    go_repository(
    ...
    # go_repository(
    #     name = "com_github_iden3_go_rapidsnark_prover",
    #     importpath = "github.com/iden3/go-rapidsnark/prover",
    #     sum = "h1:UJExuem56pawmsE03OdKmOPc/y8nPmh6+GJ54dAyzZk=",
    #     version = "v0.0.13",
    #     patches = ["//third_party:rapidsnark.patch"],
    # )
    # http_archive(
    #     name = "com_github_iden3_go_rapidsnark_prover",
    #     urls = [
    #         "https://github.com/iden3/go-rapidsnark/archive/refs/tags/prover/v0.0.13.tar.gz",
    #     ],
    #     strip_prefix = "go-rapidsnark-prover-v0.0.13/prover",
    #     build_file = "//third_party:rapidsnark/rapidsnark.BUILD",
    #     sha256 = "6e90185169f808f1133955084b1a10bd59fa262968c22d12c3e4ff83ee9cbe84",
    #     # patches = ["//third_party:rapidsnark.patch"],
    # )
    local_repository(
        name = "com_github_iden3_go_rapidsnark_prover",
        path = "rapidsnark/prover",
    )

    # go_repository(
    #     name = "com_github_iden3_wasmer_go",
    #     importpath = "github.com/iden3/wasmer-go",
    #     sum = "h1:TZKh8Se8B/73PvWrcu+FTU9L1k5XYAmtFbioj7l0Uog=",
    #     version = "v0.0.1",
    #     patches = ["//third_party:wasmer.patch"],
    # )
    local_repository(
        name = "com_github_iden3_wasmer_go",
        path = "wasmer",
