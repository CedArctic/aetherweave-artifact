...
var (
	...
	// Aetherweavekey defines the private key used to interact with the Aetherweave smart contract
	AetherweaveKey = &cli.StringFlag{
		Name:  "awkey",
		Usage: "The private key used to interact with the Aetherweave smart contract.",
		Value: "",
	}
